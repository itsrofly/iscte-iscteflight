...
echo -e "${COLOUR_BACK_BOLD_YELLOW}|    nif    |   senha   |        nome         |  nrVoo | pidCliente | pidServidorDedicado | lugarEscolhido |${COLOUR_NONE}"
...
hexdump -e '"|" 1/4 " %09d |" 1/20 " %-9s |" 1/56 " %-19s |" 1/8 " %-6s |" 1/4 " %-10d |" 1/4 " %-19d |" 1/4 " %-14d |\n"' $1
